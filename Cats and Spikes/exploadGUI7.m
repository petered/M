function varargout = exploadGUI7(varargin)
%EXPLOADGUI7 M-file for exploadGUI7.fig
%      EXPLOADGUI7, by itself, creates a new EXPLOADGUI7 or raises the existing
%      singleton*.
%
%      H = EXPLOADGUI7 returns the handle to a new EXPLOADGUI7 or the handle to
%      the existing singleton*.
%
%      EXPLOADGUI7('Property','Value',...) creates a new EXPLOADGUI7 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to exploadGUI7_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      EXPLOADGUI7('CALLBACK') and EXPLOADGUI7('CALLBACK',hObject,...) call the
%      local function named CALLBACK in EXPLOADGUI7.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help exploadGUI7

% Last Modified by GUIDE v2.5 12-Feb-2011 14:29:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @exploadGUI7_OpeningFcn, ...
                   'gui_OutputFcn',  @exploadGUI7_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before exploadGUI7 is made visible.
function exploadGUI7_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for exploadGUI7
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes exploadGUI7 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = exploadGUI7_OutputFcn(hObject, eventdata, handles)
...
function editXXX_Callback(hObject, eventdata, handles)
% hObject    handle to editXXX (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editXXX as text
%        str2double(get(hObject,'String')) returns contents of editXXX as a double


% --- Executes during object creation, after setting all properties.
function editXXX_CreateFcn(hObject, eventdata, handles)
% hObject    handle to editXXX (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --- Executes on button press in pushXXXFind.
function pushXXXFind_Callback(hObject, eventdata, handles)
% hObject    handle to pushXXXFind (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in pushXXXAdd.
function pushXXXAdd_Callback(hObject, eventdata, handles)
% hObject    handle to pushXXXAdd (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
